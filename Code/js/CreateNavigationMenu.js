...
function Create_Body()
{
   ...
   //add_js("Code/js/Tracking_Subjects.js");
    ...
    // Fathers
    var father1 = Create_Link(1, true, 'null', 'bar0_2','עקרונות החבלה');
    var father2 = Create_Link(1, true, 'null', 'bar3_8','מטענים');
    var father3 = Create_Link(1, false, 'a9', 'bar9_9',' סיכום');
    ...
    ul_Son1.className = "dropdown-menu";
     var ul_Son2 = document.createElement('ul');
    ul_Son2.className = "dropdown-menu";
    
      
    // Adding to the dropdown menu list 
    ul_Son1.appendChild(Create_Link(2, false, 'a0', 'bar0_0','כללי'));
    ul_Son1.appendChild(Create_Link(2, false, 'a1', 'bar1_1',' חדירות הלבנה'));
     ul_Son1.appendChild(Create_Link(2, false, 'a2', 'bar2_2',' עקרונות הרסיקות'));
    
    ul_Son2.appendChild(Create_Link(2, false, 'a3', 'bar3_3',' ניתוק לוחות'));
    ul_Son2.appendChild(Create_Link(2, false, 'a4', 'bar4_4',' ניתוק גלילים'));
    ul_Son2.appendChild(Create_Link(2, false, 'a5', 'bar5_5',' גזירה'));
    ul_Son2.appendChild(Create_Link(2, false, 'a6', 'bar6_6','פריצה'));
    ul_Son2.appendChild(Create_Link(2, false, 'a7', 'bar7_7',' זעזוע'));
    ul_Son2.appendChild(Create_Link(2, false, 'a8', 'bar8_8',' קדח'));
    
    
   father1.appendChild(ul_Son1);
    father2.appendChild(ul_Son2);
  
    
    //Adding it all to the list 
    Menu_ul.appendChild(father1);
    Menu_ul.appendChild(father2);
    Menu_ul.appendChild(father3);
    ...
    Credits_Link.href="Screens/Credits_Ver.3.1_Canvas.html";
...
function HandleEvent(e)
{
   ...
   // console.log("HNDELE EVENT= "+e.data);
    ...
    {
        window.location = "Screens/Credits_Ver.3.1_Canvas.html";
    }
}
